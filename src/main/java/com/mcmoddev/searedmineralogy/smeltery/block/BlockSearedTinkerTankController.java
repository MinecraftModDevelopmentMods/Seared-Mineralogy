...
public class BlockSearedTinkerTankController extends BlockTinkerTankController implements ISearedObject {
	private Block baseBlock;

	public BlockSearedTinkerTankController(Block baseBlock) {
		super();
