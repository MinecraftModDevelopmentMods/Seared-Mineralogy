...
public class BlockSearedSlab2 extends slimeknights.tconstruct.smeltery.block.BlockSearedSlab2 implements ISearedObject {
	private Block baseBlock;

	public BlockSearedSlab2(Block block) {
